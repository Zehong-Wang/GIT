...
dataset = 'bookhis' # ['bookhis', 'bookchild', 'elecomp', 'elephoto', 'sportsfit', 'amazonratings']

sweep_config = {
    "project": "SGFM-Finetune",
    "name": f"E-commerce In-context Learning Hyper-parameter Tuning -- {dataset}",
    "method": "bayes",
    ...
    "parameters": {
        ...
        "group": {"value": f"sweep-ecommerce-in-context"},
