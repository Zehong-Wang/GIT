...
for dataset in bookhis bookchild elecomp elephoto sportsfit amazonratings WN18RR FB15K237 codex_s codex_m codex_l NELL995 GDELT ICEWS1819
do
...
for dataset in bookhis bookchild elecomp elephoto sportsfit amazonratings WN18RR FB15K237 codex_s codex_m codex_l NELL995 GDELT ICEWS1819 chemhiv bbbp bace toxcast cyp450 tox21 muv products chempcba
do
    for setting in base
    do
        ~/.conda/envs/OFA/bin/python finetune.py --pt_data default --sft_data $sft_data \
